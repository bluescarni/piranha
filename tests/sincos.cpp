...
BOOST_AUTO_TEST_CASE(sin_test_00)
{
    ...
    BOOST_CHECK_EQUAL(piranha::sin(4.5f), std::sin(4.5f));
    BOOST_CHECK_EQUAL(piranha::sin(4.5), std::sin(4.5));
    BOOST_CHECK_EQUAL(piranha::sin(4.5l), std::sin(4.5l));
    BOOST_CHECK((std::is_same<decltype(piranha::sin(4.5f)), float>::value));
    BOOST_CHECK((std::is_same<decltype(piranha::sin(4.5)), double>::value));
    BOOST_CHECK((std::is_same<decltype(piranha::sin(4.5l)), long double>::value));
    BOOST_CHECK_EQUAL(piranha::sin(0), 0);
    BOOST_CHECK_EQUAL(piranha::sin(0u), 0u);
    BOOST_CHECK_EQUAL(piranha::sin(static_cast<signed char>(0)), static_cast<signed char>(0));
    BOOST_CHECK((std::is_same<decltype(piranha::sin(0)), int>::value));
    BOOST_CHECK((std::is_same<decltype(piranha::sin(0u)), unsigned>::value));
    BOOST_CHECK((std::is_same<decltype(piranha::sin(static_cast<signed char>(0))), signed char>::value));
...
BOOST_AUTO_TEST_CASE(cos_test_00)
{
    ...
    BOOST_CHECK_EQUAL(piranha::cos(4.5f), std::cos(4.5f));
    BOOST_CHECK_EQUAL(piranha::cos(4.5), std::cos(4.5));
    BOOST_CHECK_EQUAL(piranha::cos(4.5l), std::cos(4.5l));
    BOOST_CHECK((std::is_same<decltype(piranha::cos(4.5f)), float>::value));
    BOOST_CHECK((std::is_same<decltype(piranha::cos(4.5)), double>::value));
    BOOST_CHECK((std::is_same<decltype(piranha::cos(4.5l)), long double>::value));
    BOOST_CHECK_EQUAL(piranha::cos(0), 1);
    BOOST_CHECK_EQUAL(piranha::cos(0u), 1u);
    BOOST_CHECK_EQUAL(piranha::cos(static_cast<signed char>(0)), static_cast<signed char>(1));
    BOOST_CHECK((std::is_same<decltype(piranha::cos(0)), int>::value));
    BOOST_CHECK((std::is_same<decltype(piranha::cos(0u)), unsigned>::value));
    BOOST_CHECK((std::is_same<decltype(piranha::cos(static_cast<signed char>(0))), signed char>::value));
