...
static_assert(MPFR_PREC_MIN <= 4 && MPFR_PREC_MAX >= 4,
              "The unit tests for piranha::real assume that 4 is a valid value "
              "for significand precision.");
static_assert(piranha::real::default_prec < MPFR_PREC_MAX,
              "The unit tests for piranha::real assume that the default "
              "precision is strictly less-than the maximum MPFR precision.");
...
const boost::fusion::vector<char, signed char, short, int, long, long long,
                            unsigned char, unsigned short, unsigned,
                            unsigned long, unsigned long long>
integral_values((char)42, (signed char)42, (short)42, -42, 42L, -42LL,
...
struct check_integral_construction {
  template <typename T> void operator()(const T &value) const {
    if (value > T(0)) {
      BOOST_CHECK_EQUAL("4.00e1",
                        boost::lexical_cast<std::string>(real(value, 4)));
    } else {
      BOOST_CHECK_EQUAL("-4.00e1",
                        boost::lexical_cast<std::string>(real(value, 4)));
    }
...
BOOST_AUTO_TEST_CASE(real_constructors_test) {
  init();
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{}),
                    "0.00000000000000000000000000000000000");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"1.23"}),
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{real{"1.23"}, 4}),
                    "1.25");
  // Generic constructor.
  if (std::numeric_limits<float>::is_iec559 &&
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{-4.f, 4}), "-4.00");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{.5f, 4}),
                      "5.00e-1");
  }
  if (std::numeric_limits<double>::is_iec559 &&
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{-4., 4}), "-4.00");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{-.5, 4}),
                      "-5.00e-1");
  }
  if (std::numeric_limits<long double>::is_iec559 &&
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{-4.l, 4}), "-4.00");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{-.5l, 4}),
                      "-5.00e-1");
  }
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{integer(), 4}),
                    "0.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{integer(2), 4}),
                    "2.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{integer(-10), 4}),
                    "-1.00e1");
  BOOST_CHECK_EQUAL(
      boost::lexical_cast<std::string>(real{mp_integer<16>(-10), 4}),
      "-1.00e1");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{rational(), 4}),
                    "0.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{rational(2), 4}),
                    "2.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{rational(-10), 4}),
                    "-1.00e1");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{rational(-1, 2), 4}),
                    "-5.00e-1");
  BOOST_CHECK_EQUAL(
      boost::lexical_cast<std::string>(real{mp_rational<32>(-1, 2), 4}),
      "-5.00e-1");
  // Type trait.
  BOOST_CHECK(
      (!std::is_constructible<real,
...
BOOST_AUTO_TEST_CASE(real_precision_test) {
  ...
  BOOST_CHECK_EQUAL((real{0.1, MPFR_PREC_MIN + 1}.get_prec()),
                    MPFR_PREC_MIN + 1);
  real r{1};
  r.set_prec(4);
...
BOOST_AUTO_TEST_CASE(real_swap_test) {
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1),
                    "0.00000000000000000000000000000000000");
...
struct check_integral_assignment {
  template <typename T> void operator()(const T &value) const {
    ...
    r = value;
    if (value > T(0)) {
      BOOST_CHECK_EQUAL("4.20000000000000000000000000000000000e1",
...
BOOST_AUTO_TEST_CASE(real_assignment_test) {
  ...
  if (std::numeric_limits<float>::is_iec559 &&
    ...
    r1 = -.5f;
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1),
                      "-5.00000000000000000000000000000000000e-1");
...
struct check_integral_conversion {
  template <typename T> void operator()(const T &value) const {
    ...
    if (std::numeric_limits<double>::is_iec559 &&
      ...
      if (value > T(0)) {
        BOOST_CHECK_EQUAL(
            static_cast<T>(real{static_cast<double>(value) + 0.5}), value);
      } else {
        BOOST_CHECK_EQUAL(
            static_cast<T>(real{static_cast<double>(value) - 0.5}), value);
      }
    ...
    BOOST_CHECK_THROW(
        (void)static_cast<T>(real{integer(std::numeric_limits<T>::max()) * 2}),
        std::overflow_error);
    if (std::is_signed<T>::value) {
      BOOST_CHECK_THROW((void)static_cast<T>(
                            real{integer(std::numeric_limits<T>::min()) * 2}),
                        std::overflow_error);
    }
  }
};
...
BOOST_AUTO_TEST_CASE(real_conversion_test) {
  ...
  BOOST_CHECK_THROW((void)static_cast<integer>(real{"inf"}),
                    std::overflow_error);
  BOOST_CHECK_THROW((void)static_cast<integer>(real{"-inf"}),
                    std::overflow_error);
  BOOST_CHECK_THROW((void)static_cast<integer>(real{"nan"}),
                    std::overflow_error);
  BOOST_CHECK_THROW((void)static_cast<integer>(real{"-nan"}),
                    std::overflow_error);
  ...
  if (std::numeric_limits<double>::has_quiet_NaN) {
    BOOST_CHECK(static_cast<double>(real{"nan"}) !=
                std::numeric_limits<double>::quiet_NaN());
  } else {
    BOOST_CHECK_THROW((void)static_cast<double>(real{"nan"}),
                      std::overflow_error);
  }
  if (std::numeric_limits<double>::has_infinity) {
    BOOST_CHECK_EQUAL(static_cast<double>(real{"inf"}),
                      std::numeric_limits<double>::infinity());
    BOOST_CHECK_EQUAL(static_cast<double>(real{"-inf"}),
                      -std::numeric_limits<double>::infinity());
  } else {
    BOOST_CHECK_THROW((void)static_cast<double>(real{"inf"}),
                      std::overflow_error);
    BOOST_CHECK_THROW((void)static_cast<double>(real{"-inf"}),
                      std::overflow_error);
  }
  ...
  if (std::numeric_limits<float>::has_quiet_NaN) {
    BOOST_CHECK(static_cast<float>(real{"nan"}) !=
                std::numeric_limits<float>::quiet_NaN());
  } else {
    BOOST_CHECK_THROW((void)static_cast<float>(real{"nan"}),
                      std::overflow_error);
  }
  if (std::numeric_limits<float>::has_infinity) {
    BOOST_CHECK_EQUAL(static_cast<float>(real{"inf"}),
                      std::numeric_limits<float>::infinity());
    BOOST_CHECK_EQUAL(static_cast<float>(real{"-inf"}),
                      -std::numeric_limits<float>::infinity());
  } else {
    BOOST_CHECK_THROW((void)static_cast<float>(real{"inf"}),
                      std::overflow_error);
    BOOST_CHECK_THROW((void)static_cast<float>(real{"-inf"}),
                      std::overflow_error);
  }
  ...
  if (std::numeric_limits<long double>::has_quiet_NaN) {
    BOOST_CHECK(static_cast<long double>(real{"nan"}) !=
                std::numeric_limits<long double>::quiet_NaN());
  } else {
    BOOST_CHECK_THROW((void)static_cast<long double>(real{"nan"}),
                      std::overflow_error);
  }
  if (std::numeric_limits<long double>::has_infinity) {
    BOOST_CHECK_EQUAL(static_cast<long double>(real{"inf"}),
                      std::numeric_limits<long double>::infinity());
    BOOST_CHECK_EQUAL(static_cast<long double>(real{"-inf"}),
                      -std::numeric_limits<long double>::infinity());
  } else {
    BOOST_CHECK_THROW((void)static_cast<long double>(real{"inf"}),
                      std::overflow_error);
    BOOST_CHECK_THROW((void)static_cast<long double>(real{"-inf"}),
                      std::overflow_error);
  }
  ...
  BOOST_CHECK_EQUAL(static_cast<rational>(real{"-7.59375"}),
                    rational(243, -32));
  BOOST_CHECK_EQUAL(static_cast<mp_rational<16>>(real{"-7.59375"}),
                    mp_rational<16>(243, -32));
  BOOST_CHECK_THROW((void)static_cast<rational>(real{"nan"}),
                    std::overflow_error);
  BOOST_CHECK_THROW((void)static_cast<rational>(real{"inf"}),
                    std::overflow_error);
  BOOST_CHECK_THROW((void)static_cast<rational>(real{"-inf"}),
                    std::overflow_error);
  // Type traits.
...
struct check_binary_add_integral {
  template <typename T> void operator()(const T &value) const {
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(value + real{"inf"}),
                      "inf");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"-inf"} + value),
                      "-inf");
...
BOOST_AUTO_TEST_CASE(real_addition_test) {
  ...
  if (std::numeric_limits<float>::is_iec559 &&
    ...
    r1 += 2.f;
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1),
                      "8.50000000000000000000000000000000000");
    r1 += 2.5f;
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1),
                      "1.10000000000000000000000000000000000e1");
    r1 += -4.5f;
    float x = 4.f;
    x += real(".5");
  ...
  // Binary addition.
  r1 = 2;
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1 + r1),
                    "4.00000000000000000000000000000000000");
  r2 = 2;
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r2 + r2), "4.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1 + r2),
                    "4.00000000000000000000000000000000000");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r2 + r1),
                    "4.00000000000000000000000000000000000");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r2 + real("inf")), "inf");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real("-inf") + r2),
                    "-inf");
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r2 + mp_integer<16>(1)),
                    "3.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(mp_integer<32>(1) + r2),
                    "3.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"inf"} + integer(1)),
                    "inf");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(integer(1) + real{"inf"}),
                    "inf");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r2 + rational(1, 2)),
                    "2.50");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(rational(1, 2) + r2),
                    "2.50");
  BOOST_CHECK_EQUAL(
      boost::lexical_cast<std::string>(r2 + mp_rational<32>(1, 2)), "2.50");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(mp_rational<8>(1, 2) + r2),
                    "2.50");
  if (std::numeric_limits<float>::is_iec559 &&
      std::numeric_limits<float>::radix == 2) {
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(.5f + real{1, 4}),
                      "1.50");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{1, 4} + .5f),
                      "1.50");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(.5f + real{"inf"}),
                      "inf");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"-inf"} + .5f),
                      "-inf");
  }
  if (std::numeric_limits<float>::has_infinity) {
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(
                          real{1} + std::numeric_limits<float>::infinity()),
                      "inf");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(
                          -std::numeric_limits<float>::infinity() + real{1}),
                      "-inf");
  }
  if (std::numeric_limits<double>::is_iec559 &&
      std::numeric_limits<double>::radix == 2) {
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(.5 + real{1, 4}),
                      "1.50");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{1, 4} + .5),
                      "1.50");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(.5 + real{"inf"}),
                      "inf");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"-inf"} + .5),
                      "-inf");
  }
  if (std::numeric_limits<double>::has_infinity) {
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(
                          real{1} + std::numeric_limits<double>::infinity()),
                      "inf");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(
                          -std::numeric_limits<double>::infinity() + real{1}),
                      "-inf");
  }
  if (std::numeric_limits<long double>::is_iec559 &&
      std::numeric_limits<long double>::radix == 2) {
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(.5l + real{1, 4}),
                      "1.50");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{1, 4} + .5l),
                      "1.50");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(.5l + real{"inf"}),
                      "inf");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"-inf"} + .5l),
                      "-inf");
  }
  if (std::numeric_limits<long double>::has_infinity) {
    BOOST_CHECK_EQUAL(
        boost::lexical_cast<std::string>(
            real{1} + std::numeric_limits<long double>::infinity()),
        "inf");
    BOOST_CHECK_EQUAL(
        boost::lexical_cast<std::string>(
            -std::numeric_limits<long double>::infinity() + real{1}),
        "-inf");
  }
...
BOOST_AUTO_TEST_CASE(real_subtraction_test) {
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(rational(1, 2) - r2),
                    "-1.50");
  BOOST_CHECK_EQUAL(
      boost::lexical_cast<std::string>(r2 - mp_rational<16>(1, 2)), "1.50");
  BOOST_CHECK_EQUAL(
      boost::lexical_cast<std::string>(mp_rational<32>(1, 2) - r2), "-1.50");
  if (std::numeric_limits<float>::is_iec559 &&
      std::numeric_limits<float>::radix == 2) {
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(.5f - real{1, 4}),
                      "-5.00e-1");
...
BOOST_AUTO_TEST_CASE(real_multiplication_test) {
  ...
  if (std::numeric_limits<float>::is_iec559 &&
    ...
    r1 *= 2.5f;
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1),
                      "1.50000000000000000000000000000000000e1");
    r1 = 3;
    float x = 4.f;
    x *= real(".5");
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r2 * mp_integer<16>(2)),
                    "4.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(mp_integer<32>(2) * r2),
                    "4.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"inf"} * integer(1)),
                    "inf");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(integer(1) * real{"inf"}),
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(rational(1, 2) * r2),
                    "1.00");
  BOOST_CHECK_EQUAL(
      boost::lexical_cast<std::string>(r2 * mp_rational<16>(1, 2)), "1.00");
  BOOST_CHECK_EQUAL(
      boost::lexical_cast<std::string>(mp_rational<32>(1, 2) * r2), "1.00");
  if (std::numeric_limits<float>::is_iec559 &&
      std::numeric_limits<float>::radix == 2) {
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(.5f * real{1, 4}),
                      "5.00e-1");
...
BOOST_AUTO_TEST_CASE(real_division_test) {
  ...
  r1 /= -real{"2."};
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1),
                    "-2.50000000000000000000000000000000000e-1");
  BOOST_CHECK_EQUAL(r1.get_prec(), real::default_prec);
  r1 /= real();
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r1), "-inf");
  r1 /= real();
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r2 / r1),
                    "1.00000000000000000000000000000000000");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(r2 / real("inf", 4)),
                    "0.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real("-inf") / r2),
                    "-inf");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real("-nan") / r2), "nan");
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(rational(1, 2) / r2),
                    "2.50e-1");
  BOOST_CHECK_EQUAL(
      boost::lexical_cast<std::string>(r2 / mp_rational<16>(1, 2)), "4.00");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(mp_rational<8>(1, 2) / r2),
                    "2.50e-1");
  if (std::numeric_limits<float>::is_iec559 &&
      std::numeric_limits<float>::radix == 2) {
...
BOOST_AUTO_TEST_CASE(real_equality_test) {
  ...
  BOOST_CHECK(
      (std::is_same<bool, decltype(real{} == mp_rational<8>{})>::value));
  ...
  BOOST_CHECK((std::is_same<bool, decltype(real{} == static_cast<long double>(
                                                         0))>::value));
...
BOOST_AUTO_TEST_CASE(real_stream_test) {
  ...
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"+inf"}), "inf");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"-inf"}), "-inf");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"3"}),
                    "3.00000000000000000000000000000000000");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"30"}),
                    "3.00000000000000000000000000000000000e1");
  BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(real{"0.5"}),
                    "5.00000000000000000000000000000000000e-1");
  {
...
BOOST_AUTO_TEST_CASE(real_pow_test) {
  ...
  BOOST_CHECK_EQUAL(math::pow(real{3}, rational(1, 4)),
                    math::pow(real{3}, real{rational(1, 4)}));
  // Check precision handling.
...
BOOST_AUTO_TEST_CASE(real_fma_test) {
  ...
  r2.multiply_accumulate((real{2, real::default_prec + ::mpfr_prec_t(1)}),
                         real{3});
  ...
  // NOTE: this could actually fail if/when we switch back to the fma() from
  // MPFR,
  ...
  // and only the final add in 500 bits. While for the fma we are doing
  // everything
  // at 500 bits.
  r4 = real{".2", 500};
  r4.multiply_accumulate(real{"-.2", 200}, real{".2", 200});
...
BOOST_AUTO_TEST_CASE(real_evaluate_test) {
  BOOST_CHECK_EQUAL(
      math::evaluate(real(), std::unordered_map<std::string, integer>{}),
      real());
  BOOST_CHECK_EQUAL(
      math::evaluate(real(2), std::unordered_map<std::string, int>{}), real(2));
  BOOST_CHECK_EQUAL(
      math::evaluate(real(-3.5), std::unordered_map<std::string, double>{}),
      real(-3.5));
  BOOST_CHECK(
      (std::is_same<decltype(math::evaluate(
                        real(), std::unordered_map<std::string, real>{})),
                    real>::value));
}
...
BOOST_AUTO_TEST_CASE(real_binomial_test) {
  ...
  BOOST_CHECK((
      std::is_same<real, decltype(math::binomial(rational{}, real{}))>::value));
  BOOST_CHECK(
      (std::is_same<real, decltype(math::binomial(real{}, integer{}))>::value));
  // Invalid values.
  ...
  for (int i = 0; i < ntries; ++i) {
    ...
    BOOST_CHECK((int_res == 0 || tmp.abs() < 1E30) ||
                ((tmp - int_res) / int_res).abs() < 1E-30);
  }
  // No negative integers.
  // This coincides with mpmath and wolfram alpha (roughly).
  BOOST_CHECK_EQUAL(math::binomial(real{"12345.6"}, real{"7.89"}),
                    real{"5.99111763882803518776029814739451218e27"});
  // Inf denominator.
  BOOST_CHECK_EQUAL(math::binomial(real{"12345.6"}, real{"-2"}), real{});
  BOOST_CHECK_EQUAL(math::binomial(real{"1234"}, real{"-2"}), real{});
  BOOST_CHECK_EQUAL(
      math::binomial(real("12345.6", real::default_prec + 1), real{"-2"})
          .get_prec(),
      real::default_prec + 1);
  BOOST_CHECK_EQUAL(
      math::binomial(real("1234"), real("-2", real::default_prec + 1))
          .get_prec(),
      real::default_prec + 1);
  // Case 3.
  BOOST_CHECK_EQUAL(math::binomial(real{"-3"}, real{"-5"}),
                    real{"5.99999999999999999999999999999999846"});
  // Case 5.
  BOOST_CHECK_EQUAL(math::binomial(real{"-3"}, real{"2"}),
                    real{"5.99999999999999999999999999999999846"});
  // Case 7.
  BOOST_CHECK_EQUAL(math::binomial(real{"-3"}, real{"-2"}), real{});
  BOOST_CHECK_EQUAL(
      math::binomial(real("-3", real::default_prec + 1), real{"-2"}).get_prec(),
      real::default_prec + 1);
  BOOST_CHECK_EQUAL(
      math::binomial(real("-3"), real("-2", real::default_prec + 1)).get_prec(),
      real::default_prec + 1);
}
...
BOOST_AUTO_TEST_CASE(real_type_traits_test) {
  ...
  BOOST_CHECK(!has_negate<const real>::value);
  BOOST_CHECK(
      (std::is_same<decltype(math::negate(*(real *)nullptr)), void>::value));
...
BOOST_AUTO_TEST_CASE(real_safe_cast_test) {
  ...
  BOOST_CHECK_THROW(safe_cast<int>(real{std::numeric_limits<int>::max()} * 2),
                    std::invalid_argument);
  BOOST_CHECK_THROW(safe_cast<int>(real{std::numeric_limits<int>::min()} * 2),
                    std::invalid_argument);
  ...
  BOOST_CHECK_THROW(
      safe_cast<unsigned>(real{std::numeric_limits<unsigned>::max()} * 2),
      std::invalid_argument);
...
BOOST_AUTO_TEST_CASE(real_serialization_test) {
  std::uniform_int_distribution<::mpfr_prec_t> prec_dist(::mpfr_prec_t(10),
                                                         ::mpfr_prec_t(100));
