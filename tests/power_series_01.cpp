...
class g_series_type
    : public power_series<series<Cf, monomial<Expo>, g_series_type<Cf, Expo>>,
                          g_series_type<Cf, Expo>> {
  using base = power_series<series<Cf, monomial<Expo>, g_series_type<Cf, Expo>>,
                            g_series_type<Cf, Expo>>;
...
class g_series_type2
    : public power_series<series<Cf, rtk_monomial, g_series_type2<Cf>>,
                          g_series_type2<Cf>> {
  typedef power_series<series<Cf, rtk_monomial, g_series_type2<Cf>>,
                       g_series_type2<Cf>>
      base;
  PIRANHA_SERIALIZE_THROUGH_BASE(base)
public:
...
struct degree_tester {
  template <typename Cf> struct runner {
    template <typename Expo> void operator()(const Expo &) {
      ...
      typedef polynomial<polynomial<Cf, monomial<Expo>>, monomial<Expo>>
          p_type11;
      using deg_type = typename std::conditional<std::is_same<Expo, int>::value,
                                                 int, integer>::type;
      BOOST_CHECK(
          (std::is_same<deg_type, decltype(math::degree(p_type1{}))>::value));
      BOOST_CHECK(
          (std::is_same<deg_type,
                        decltype(math::degree(
                            p_type1{}, std::vector<std::string>{}))>::value));
      BOOST_CHECK(
          (std::is_same<deg_type, decltype(math::ldegree(p_type1{}))>::value));
      BOOST_CHECK(
          (std::is_same<deg_type,
                        decltype(math::ldegree(
                            p_type1{}, std::vector<std::string>{}))>::value));
      ...
      BOOST_CHECK(
          math::degree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"x"}) == 1);
      BOOST_CHECK(
          math::degree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"x"}) == 1);
      BOOST_CHECK(
          math::degree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"y"}) == 1);
      BOOST_CHECK(
          math::degree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"y"}) == 1);
      BOOST_CHECK(
          math::degree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"z"}) == 0);
      BOOST_CHECK(
          math::degree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"z"}) == 0);
      BOOST_CHECK(math::ldegree(p_type1{"x"} + p_type1{"y"} + p_type1{1}) == 0);
      BOOST_CHECK(
          math::ldegree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"x"}) == 0);
      BOOST_CHECK(
          math::ldegree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"x"}) == 0);
      BOOST_CHECK(
          math::ldegree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"y"}) == 0);
      BOOST_CHECK(
          math::ldegree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"y"}) == 0);
      BOOST_CHECK(
          math::ldegree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"z"}) == 0);
      BOOST_CHECK(
          math::ldegree(p_type1{"x"} + p_type1{"y"} + p_type1{1}, {"z"}) == 0);
      BOOST_CHECK(math::ldegree(p_type1{"x"} * p_type1{"x"} + p_type1{"y"} +
                                p_type1{"x"}) == 1);
      BOOST_CHECK(math::ldegree(p_type1{"x"} * p_type1{"x"} + p_type1{"y"} +
                                    p_type1{"x"},
                                {"x"}) == 0);
      BOOST_CHECK(math::ldegree(p_type1{"x"} * p_type1{"x"} + p_type1{"y"} +
                                    p_type1{"x"},
                                {"x"}) == 0);
      BOOST_CHECK(math::ldegree(p_type1{"x"} * p_type1{"x"} + 2 * p_type1{"x"},
                                {"x"}) == 1);
      BOOST_CHECK(math::ldegree(p_type1{"x"} * p_type1{"y"} + 2 * p_type1{"x"},
                                {"x"}) == 1);
      BOOST_CHECK(math::ldegree(p_type1{"x"} * p_type1{"y"} + 2 * p_type1{"x"},
                                {"y"}) == 0);
      std::vector<std::string> empty_set;
      BOOST_CHECK((
          std::is_same<decltype(math::degree(std::declval<const p_type11 &>())),
                       deg_type>::value));
      BOOST_CHECK(
          (std::is_same<decltype(math::degree(std::declval<const p_type11 &>(),
                                              empty_set)),
                        deg_type>::value));
      BOOST_CHECK((std::is_same<decltype(math::ldegree(
                                    std::declval<const p_type11 &>())),
                                deg_type>::value));
      BOOST_CHECK(
          (std::is_same<decltype(math::ldegree(std::declval<const p_type11 &>(),
                                               empty_set)),
                        deg_type>::value));
      BOOST_CHECK(
          math::degree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"}) == 2);
      BOOST_CHECK(math::degree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"},
                               {"x"}) == 1);
      BOOST_CHECK(math::degree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"},
                               {"x"}) == 1);
      BOOST_CHECK(math::degree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"},
                               {"y"}) == 1);
      BOOST_CHECK(
          math::ldegree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"}) == 1);
      BOOST_CHECK(math::ldegree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"},
                                {"y"}) == 1);
      BOOST_CHECK(math::ldegree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"},
                                {"y"}) == 1);
      BOOST_CHECK(math::ldegree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"},
      ...
      BOOST_CHECK(math::ldegree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"},
                                {"z"}) == 0);
      BOOST_CHECK(math::ldegree(p_type11{"x"} * p_type1{"y"} +
                                2 * p_type1{"y"} + 1) == 0);
      BOOST_CHECK(
          math::ldegree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"} + 1,
                        {"x"}) == 0);
      BOOST_CHECK(
          math::ldegree(p_type11{"x"} * p_type1{"y"} + 2 * p_type1{"y"} + 1,
                        {"y"}) == 0);
      BOOST_CHECK(math::degree(p_type11{"x"} * p_type1{"y"} * p_type1{"y"} +
                               2 * p_type1{"y"} + 1) == 3);
      BOOST_CHECK(math::degree(p_type11{"x"} * p_type1{"y"} * p_type1{"y"} +
                                   2 * p_type1{"y"} + 1,
                               {"x"}) == 1);
      ...
      BOOST_CHECK(math::degree(p_type11{"x"} * p_type1{"y"} * p_type1{"y"} +
                                   2 * p_type1{"y"} + 1,
                               {"y"}) == 2);
      BOOST_CHECK(math::ldegree(p_type11{"x"} * p_type1{"y"} * p_type1{"y"} +
                                2 * p_type1{"y"} + 1) == 0);
      BOOST_CHECK(math::ldegree(p_type11{"x"} * p_type1{"y"} * p_type1{"y"} +
                                    2 * p_type1{"y"},
                                {"x"}) == 0);
      ...
      BOOST_CHECK(
          (std::is_same<deg_type, decltype(math::degree(pstype1{}))>::value));
      BOOST_CHECK(
          (std::is_same<deg_type,
                        decltype(math::degree(
                            pstype1{}, std::vector<std::string>{}))>::value));
      BOOST_CHECK(
          (std::is_same<deg_type, decltype(math::ldegree(pstype1{}))>::value));
      BOOST_CHECK(
          (std::is_same<deg_type,
                        decltype(math::ldegree(
                            pstype1{}, std::vector<std::string>{}))>::value));
      // As usual, operations on Poisson series with (polynomial) integer
      // coefficients are not gonna give
      ...
      BOOST_CHECK(
          math::degree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"x"}) == 1);
      BOOST_CHECK(
          math::degree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"x"}) == 1);
      BOOST_CHECK(
          math::degree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"y"}) == 1);
      BOOST_CHECK(
          math::degree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"y"}) == 1);
      BOOST_CHECK(
          math::degree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"z"}) == 0);
      BOOST_CHECK(
          math::degree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"z"}) == 0);
      BOOST_CHECK(math::ldegree(pstype1{"x"} + pstype1{"y"} + pstype1{1}) == 0);
      BOOST_CHECK(
          math::ldegree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"x"}) == 0);
      BOOST_CHECK(
          math::ldegree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"x"}) == 0);
      BOOST_CHECK(
          math::ldegree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"y"}) == 0);
      BOOST_CHECK(
          math::ldegree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"y"}) == 0);
      BOOST_CHECK(
          math::ldegree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"z"}) == 0);
      BOOST_CHECK(
          math::ldegree(pstype1{"x"} + pstype1{"y"} + pstype1{1}, {"z"}) == 0);
      BOOST_CHECK(math::ldegree(pstype1{"x"} * pstype1{"x"} + pstype1{"y"} +
                                pstype1{"x"}) == 1);
      BOOST_CHECK(math::ldegree(pstype1{"x"} * pstype1{"x"} + pstype1{"y"} +
                                    pstype1{"x"},
                                {"x"}) == 0);
      BOOST_CHECK(math::ldegree(pstype1{"x"} * pstype1{"x"} + pstype1{"y"} +
                                    pstype1{"x"},
                                {"x"}) == 0);
      BOOST_CHECK(math::ldegree(pstype1{"x"} * pstype1{"x"} + 2 * pstype1{"x"},
                                {"x"}) == 1);
      BOOST_CHECK(math::ldegree(pstype1{"x"} * pstype1{"y"} + 2 * pstype1{"x"},
                                {"x"}) == 1);
      BOOST_CHECK(math::ldegree(pstype1{"x"} * pstype1{"y"} + 2 * pstype1{"x"},
                                {"y"}) == 0);
    }
