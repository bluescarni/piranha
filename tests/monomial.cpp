...
struct degree_tester
{
	...
	void operator()(const T &)
	{
		...
		BOOST_CHECK(k2.ldegree(symbol_set{},v) == T(0));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("a")},v) == T(2));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("A")},v) == T(0));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("z")},v) == T(0));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("z"),symbol("A"),symbol("a")},v) == T(2));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("z"),symbol("A"),symbol("b")},v) == T(3));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("B"),symbol("A"),symbol("b")},v) == T(3));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("a"),symbol("b"),symbol("z")},v) == T(3) + T(2));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("a"),symbol("b"),symbol("A")},v) == T(3) + T(2));
		BOOST_CHECK(k2.ldegree(symbol_set{symbol("a"),symbol("b"),symbol("A"),symbol("z")},v) == T(3) + T(2));
		v.add(symbol("c"));
		key_type k3(v);
		k3[0] = T(2);
		k3[1] = T(3);
