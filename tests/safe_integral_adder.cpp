...
BOOST_AUTO_TEST_CASE(sia_test_00) {
  ...
  }
  {
    ...
    detail::safe_integral_adder(
        a, int_type(std::numeric_limits<int_type>::max() - int_type(1)));
    BOOST_CHECK_EQUAL(a, std::numeric_limits<int_type>::max());
  }
  {
    // Unsigned.
...
BOOST_AUTO_TEST_CASE(sia_test_01) {
  {
    ...
    BOOST_CHECK_EQUAL(a, 0);
    a = std::numeric_limits<int_type>::max();
    BOOST_CHECK_THROW(detail::safe_integral_subber(a, int_type(-1)),
                      std::overflow_error);
    detail::safe_integral_subber(a, int_type(1));
    ...
    a = std::numeric_limits<int_type>::max();
    detail::safe_integral_subber(
        a, int_type(std::numeric_limits<int_type>::max() / 2));
    BOOST_CHECK_EQUAL(a, std::numeric_limits<int_type>::max() -
                             std::numeric_limits<int_type>::max() / 2);
    a = std::numeric_limits<int_type>::min();
    detail::safe_integral_subber(
        a, int_type(std::numeric_limits<int_type>::min() / 2));
    BOOST_CHECK_EQUAL(a, std::numeric_limits<int_type>::min() -
  ...
  }
  {
    ...
    a = std::numeric_limits<int_type>::max();
    detail::safe_integral_subber(
        a, int_type(std::numeric_limits<int_type>::max() - 1));
    BOOST_CHECK_EQUAL(a, 1);
  }
  {
    // Unsigned.
