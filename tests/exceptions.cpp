...
struct custom_exception1 : public base_exception {
  ...
  explicit custom_exception1(const std::string &msg)
...
struct custom_exception2 : public base_exception {
  ...
  explicit custom_exception2(const std::string &msg, int)
      : base_exception(std::string(msg)) {}
};
...
struct custom_exception3 : public base_exception {
  ...
  explicit custom_exception3(const std::string &msg, int)
      : base_exception(std::string(msg)) {}
  explicit custom_exception3(int, const std::string &msg)
      : base_exception(std::string(msg)) {}
};

struct custom_exception4 : public base_exception {
  explicit custom_exception4(const char *msg)
      : base_exception(std::string(msg)) {}
};
...
BOOST_AUTO_TEST_CASE(exception_main_test) {
  ...
  BOOST_CHECK_THROW(piranha_throw(custom_exception1, std::string("")),
                    custom_exception1);
  BOOST_CHECK_THROW(piranha_throw(custom_exception1, ""), custom_exception1);
  BOOST_CHECK_THROW(piranha_throw(custom_exception2, ), custom_exception2);
  BOOST_CHECK_THROW(piranha_throw(custom_exception2, std::string("")),
                    custom_exception2);
  BOOST_CHECK_THROW(piranha_throw(custom_exception2, std::string(""), 3),
                    custom_exception2);
  BOOST_CHECK_THROW(piranha_throw(custom_exception3, ), custom_exception3);
  BOOST_CHECK_THROW(piranha_throw(custom_exception3, std::string("")),
                    custom_exception3);
  BOOST_CHECK_THROW(piranha_throw(custom_exception3, std::string(""), 3),
                    custom_exception3);
  BOOST_CHECK_THROW(piranha_throw(custom_exception3, 3, std::string("")),
                    custom_exception3);
