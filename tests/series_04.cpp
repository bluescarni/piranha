...
struct type_traits_tester {
    ...
    struct runner {
        ...
        void operator()(const Expo &)
        {
            ...
            BOOST_CHECK(!is_series<p_type11 const>::value);
            BOOST_CHECK(is_equality_comparable<const p_type1 &>::value);
            BOOST_CHECK((is_equality_comparable<const p_type1 &, const Cf &>::value));
            BOOST_CHECK((is_equality_comparable<const Cf &, const p_type1 &>::value));
            BOOST_CHECK((!is_equality_comparable<const p_type1 &, const std::string &>::value));
            BOOST_CHECK(is_equality_comparable<const p_type11 &>::value);
            BOOST_CHECK((is_equality_comparable<const p_type11 &, const p_type1 &>::value));
            BOOST_CHECK((is_equality_comparable<const p_type1 &, const p_type11 &>::value));
