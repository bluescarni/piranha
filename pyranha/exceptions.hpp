...
// NOTE: the idea here is to use non-type template parameters to handle
// generically exceptions.
// The standard Python exceptions are pointers with external linkage and as such
// they are usable as non-type template
// parameters.
...
template <PyObject **PyEx, typename CppEx> inline void generic_translate() {
