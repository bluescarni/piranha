...
inline void expose_rational_functions_impl()
{
    ...
    // Binary ctors.
    using binary_ctor_types = std::tuple<std::string, piranha::integer, piranha::rational, p_type, q_type, r_type>;
    ...
    rf_class.def("unregister_custom_derivative", r_type::unregister_custom_derivative)
        .staticmethod("unregister_custom_derivative");
    rf_class.def("unregister_all_custom_derivatives", r_type::unregister_all_custom_derivatives)
