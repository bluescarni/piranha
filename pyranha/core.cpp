...
#define PYRANHA_EXPOSE_BINOMIAL(top, bot) bp::def("_binomial", &piranha::binomial<const top &, const bot &>)
...
#define PYRANHA_EXPOSE_SIN_COS(arg)                                                                                    \
    bp::def("_sin", &piranha::sin<const arg &>);                                                                       \
    bp::def("_cos", &piranha::cos<const arg &>)
