...
template <typename Descriptor> struct poly_custom_hook {
  PIRANHA_DECLARE_HAS_TYPEDEF(degree_truncation_types);
  template <typename S> static void unset_auto_truncate_degree_wrapper() {
    S::unset_auto_truncate_degree();
  }
  template <typename S> static bp::tuple get_auto_truncate_degree_wrapper() {
  ...
  template <typename S,
            typename std::enable_if<
                piranha::detail::has_get_auto_truncate_degree<S>::value,
                int>::type = 0>
  static void
  expose_degree_auto_truncation_get_unset(bp::class_<S> &series_class) {
    series_class
        .def("unset_auto_truncate_degree",
             unset_auto_truncate_degree_wrapper<S>)
        .staticmethod("unset_auto_truncate_degree");
    series_class
        .def("get_auto_truncate_degree", get_auto_truncate_degree_wrapper<S>)
  ...
  template <typename S> struct auto_truncate_set_exposer {
    auto_truncate_set_exposer(bp::class_<S> &series_class)
    ...
    template <typename T>
    static void set_auto_truncate_pdegree_wrapper(const T &max_degree,
                                                  bp::list l) {
    ...
    void expose_set_auto_truncate_degree(
        const T &,
        typename std::enable_if<piranha::detail::has_set_auto_truncate_degree<
            S, T>::value>::type * = nullptr) const {
      m_series_class.def("set_auto_truncate_degree",
                         set_auto_truncate_degree_wrapper<T>);
      m_series_class.def("set_auto_truncate_degree",
                         set_auto_truncate_pdegree_wrapper<T>);
  ...
  // find_cf() exposition.
  template <typename S>
  static typename S::term_type::cf_type find_cf_wrapper(const S &s,
                                                        bp::list l) {
  ...
  template <typename T> static T uprem_wrapper(const T &n, const T &d) {
    return T::uprem(n, d);
  }
  template <
      typename T,
      typename std::enable_if<
          piranha::detail::true_tt<piranha::detail::ptd::enabler<T, T>>::value,
          int>::type = 0>
  ...
  template <typename... Args> void expose_join(Args &&...) const {}
  // GCD.
  template <typename T>
  static bp::tuple static_gcd_wrapper(const T &a, const T &b) {
    auto retval = T::gcd(a, b);
    return bp::make_tuple(std::move(std::get<0u>(retval)),
                          std::move(std::get<1u>(retval)),
                          std::move(std::get<2u>(retval)));
  }
  template <typename T>
  static bp::tuple
  static_gcd_wrapper_algo(const T &a, const T &b,
  ...
  template <typename T>
  static bp::tuple
  static_gcd_wrapper_cofac_algo(const T &a, const T &b, bool with_cofactors,
                                piranha::polynomial_gcd_algorithm algo) {
  ...
  template <typename T>
  static bp::tuple static_gcd_wrapper_cofac(const T &a, const T &b,
                                            bool with_cofactors) {
  ...
  template <typename T,
            typename std::enable_if<piranha::has_gcd<T>::value, int>::type = 0>
  ...
  template <typename... Args> void expose_height(Args &&...) const {}
  // Content.
  template <typename T>
  ...
  template <typename T,
            typename = decltype(std::declval<const T &>().content())>
  void expose_content(bp::class_<T> &series_class) const {
    series_class.def("content", content_wrapper<T>);
  }
  template <typename... Args> void expose_content(Args &&...) const {}
  // Primitive part.
  template <typename T>
  static auto primitive_part_wrapper(const T &p)
      -> decltype(p.primitive_part()) {
    return p.primitive_part();
  }
  template <typename T,
            typename = decltype(std::declval<const T &>().primitive_part())>
  void expose_primitive_part(bp::class_<T> &series_class) const {
    series_class.def("primitive_part", primitive_part_wrapper<T>);
  }
  template <typename... Args> void expose_primitive_part(Args &&...) const {}
  // The call operator.
  template <typename T> void operator()(bp::class_<T> &series_class) const {
    ...
    series_class.def("reset_default_gcd_algorithm",
                     T::reset_default_gcd_algorithm);
