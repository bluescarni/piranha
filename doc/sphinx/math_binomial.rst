...
.. cpp:function:: template <typename T, typename U> auto piranha::math::binomial(T &&x, U &&y)

   This function computes the binomial coefficient :math:`{x \choose y}`.

   The implementation is delegated to the call operator of the :cpp:class:`piranha::math::binomial_impl` function object.
   The body of this function is equivalent to:

   .. code-block:: c++

      return piranha::math::binomial_impl<Tp, Up>{}(x, y);

   where ``Tp`` and ``Up`` are ``T`` and ``U`` after the removal of reference and cv-qualifiers,
   and *x* and *y* are perfectly forwarded to the call operator of :cpp:class:`piranha::math::binomial_impl`.
...
.. cpp:concept:: template <typename T, typename U> piranha::BinomialTypes
   ...
   This concept is satisfied if :cpp:func:`piranha::math::binomial()` can be called
...
.. cpp:class:: template <typename T, typename U, typename Enable = void> piranha::math::binomial_impl

   Unspecialised version of the function object implementing :cpp:func:`piranha::math::binomial()`.

   This default implementation does not define any call operator, and thus no default implementation
   of :cpp:func:`piranha::math::binomial()` is available.

.. cpp:class:: template <CppIntegral T, CppIntegral U> piranha::math::binomial_impl<T, U>

   Specialisation of the function object implementing :cpp:func:`piranha::math::binomial()` for C++'s integral types.
...
.. cpp:class:: template <typename U, mppp::IntegerIntegralOpTypes<U> T> piranha::math::binomial_impl<T, U>

   Specialisation of the function object implementing :cpp:func:`piranha::math::binomial()` for :cpp:class:`mppp::integer <mppp::integer>`.

   This implementation will invoke one of mp++'s :ref:`integer binomial <mppp:integer_ntheory>` overloads.

   :exception unspecified: any exception thrown by the invoked :ref:`integer binomial <mppp:integer_ntheory>` overload.

.. cpp:class:: template <std::size_t SSize, mppp::RationalIntegralInteroperable<SSize> T> piranha::math::binomial_impl<mppp::rational<SSize>, T>

   *#include <piranha/rational.hpp>*

   Specialisation of the function object implementing :cpp:func:`piranha::math::binomial()` for :cpp:class:`mppp::rational <mppp::rational>`
