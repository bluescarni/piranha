...
if(CMAKE_COMPILER_IS_CLANGXX OR CMAKE_COMPILER_IS_GNUCXX)
	...
	# NOTE: setup for a couple of type traits that are missing in the currently supported versions of GCC.
	# This applies to Clang as well, when using the GNU standard library.
	try_compile(PIRANHA_HAS_IS_TRIVIALLY_DESTRUCTIBLE ${CMAKE_BINARY_DIR} "${CMAKE_SOURCE_DIR}/cmake_modules/is_trivially_destructible.cpp")
	try_compile(PIRANHA_HAS_HAS_TRIVIAL_DESTRUCTOR ${CMAKE_BINARY_DIR} "${CMAKE_SOURCE_DIR}/cmake_modules/has_trivial_destructor.cpp")
	if(PIRANHA_HAS_IS_TRIVIALLY_DESTRUCTIBLE)
		message(STATUS "std::is_trivially_destructible type trait detected.")
		set(PIRANHA_IS_TRIVIALLY_DESTRUCTIBLE "std::is_trivially_destructible")
	elseif(PIRANHA_HAS_HAS_TRIVIAL_DESTRUCTOR)
		message(STATUS "std::has_trivial_destructor type trait detected.")
		set(PIRANHA_IS_TRIVIALLY_DESTRUCTIBLE "std::has_trivial_destructor")
	else()
		message(STATUS "boost::has_trivial_destructor type trait detected.")
		set(PIRANHA_IS_TRIVIALLY_DESTRUCTIBLE "boost::has_trivial_destructor")
	endif()
	try_compile(PIRANHA_HAS_IS_TRIVIALLY_COPYABLE ${CMAKE_BINARY_DIR} "${CMAKE_SOURCE_DIR}/cmake_modules/is_trivially_copyable.cpp")
	try_compile(PIRANHA_HAS_HAS_TRIVIAL_COPY_CONSTRUCTOR ${CMAKE_BINARY_DIR} "${CMAKE_SOURCE_DIR}/cmake_modules/has_trivial_copy_constructor.cpp")
	if(PIRANHA_HAS_IS_TRIVIALLY_COPYABLE)
		message(STATUS "std::is_trivially_copyable type trait detected.")
		set(PIRANHA_IS_TRIVIALLY_COPYABLE "std::is_trivially_copyable")
	elseif(PIRANHA_HAS_HAS_TRIVIAL_COPY_CONSTRUCTOR)
		message(STATUS "std::has_trivial_copy_constructor type trait detected.")
		set(PIRANHA_IS_TRIVIALLY_COPYABLE "std::has_trivial_copy_constructor")
	else()
		message(STATUS "boost::has_trivial_copy_constructor type trait detected.")
		set(PIRANHA_IS_TRIVIALLY_COPYABLE "boost::has_trivial_copy_constructor")
	endif()
endif()
