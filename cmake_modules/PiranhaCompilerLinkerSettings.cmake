...
IF(CMAKE_COMPILER_IS_GNUCXX)
	...
	ELSE(GNUCXX_STD_CPP11)
		...
		IF(GNUCXX_STD_CPP0X)
		    ...
		    #add __GXX_EXPERIMENTAL_CXX0X__ for eclipse to see it
			IF(CMAKE_ECLIPSE_EXECUTABLE)
		        ADD_DEFINITIONS(-D__GXX_EXPERIMENTAL_CXX0X__)
		    ENDIF(CMAKE_ECLIPSE_EXECUTABLE)
	...
	# MINGW with gcc 4.6.1 has a problem with that. There is a bug in the library that leads to bad_cast from boost::lexical_cast
	IF(NOT MINGW)
