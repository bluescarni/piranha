 ...
 * In order to avoid clashes with copy/move constructors, in case the only argument is of type \p Derived
 ...
 * In order to avoid clashes with copy/move assignment operators, in case the argument is of type \p Derived
