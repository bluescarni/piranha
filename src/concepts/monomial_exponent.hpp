...
#ifndef PIRANHA_CONCEPT_MONOMIAL_EXPONENT_HPP
#define PIRANHA_CONCEPT_MONOMIAL_EXPONENT_HPP
...
/// Concept for types suitable for use as exponents in piranha::monomial.
/**
 ...
 */
template <typename T>
struct MonomialExponent:
	ContainerElement<T>
{
	/// Concept usage pattern.
	BOOST_CONCEPT_USAGE(MonomialExponent)
	{
		T inst = T(0);
