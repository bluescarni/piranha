 ...
 * memory allocation by using internal static storage up to a certain number of stored elements. If \p S is a zero
 * integral constant, this
 * number is calculated automatically (but it will always be at least 1). Otherwise, the limit number is set to \p
 * S::value.
 *
 * ## Type requirements ##
 *
