...
setup(name=NAME,
    ...
    package_data={'pyranha': ['_core.pyd','libboost_iostreams-mgw62-mt-1_62.dll',BOOST_PYTHON_LIB,'libboost_serialization-mgw62-mt-1_62.dll','libboost_zlib-mgw62-mt-1_62.dll','libboost_bzip2-mgw62-mt-1_62.dll','libgcc_s_seh-1.dll','libstdc++-6.dll','libwinpthread-1.dll']},
